...
- docker-compose.yml maps the .ssh directory in your home dir to /root/.ssh-volume and copies the files with proper access rights to /root/.ssh (because on a Windows host PC, access rights are wrong!). Make sure you have a key setup and GitHub knows the key.
